...
"
" Maintainer:	Michael Dou [Bram Moolenaar <Bram@vim.org>]
" Last change:  23/10/2012 [2008 Dec 17]
"
...
"map <C-c> : call FuncColorElflord() <CR>
"map <C-d> : call FuncColorDarkblue() <CR>
"map <C-k> : call FuncColorKoehler() <CR>
"map <C-m> : call FuncColorMurphy() <CR>
"map <C-t> : call FuncColorTorte() <CR>
